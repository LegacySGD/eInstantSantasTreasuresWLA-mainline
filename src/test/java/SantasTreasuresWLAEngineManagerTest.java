...
public class SantasTreasuresWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SantasTreasuresWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SantasTreasuresWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SantasTreasuresWLAIW/InitOutcome.xml").getDocumentElement();
